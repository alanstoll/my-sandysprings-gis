...
cd backend && gradlew prepareGeology # re-clips data/layers/geology-* from the USGS National Geologic Map Earth Surface service
...
- Geology: [USGS National Geologic Map](https://ngmdb.usgs.gov/nationalgeology) v2, Earth Surface synthesis, whose source here is Lawton and others, 1976, Geologic map of Georgia, 1:500,000 (public domain)
